 ...
 */
public class AuntDalaActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.aunt_dala);

        Intent it=this.getIntent();
        worksList=(List<Worker>)it.getSerializableExtra("dalaaunts");
        session=it.getStringExtra("session");

        delete=(ImageView)findViewById(R.id.dalaclear);
        search=(EditText)findViewById(R.id.dalasearch);
        ...
        final ListView lv1=(ListView)findViewById(R.id.listviewdala);
        WorksAdapter worksAdapter=new WorksAdapter(AuntDalaActivity.this,R.layout.listitem,worksList);
        ...
        lv1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent it = new Intent(AuntDalaActivity.this, AuntActivity.class);
                Bundle bundle = new Bundle();
                bundle.putSerializable("worker", pass);
                it.putExtras(bundle);
                it.putExtra("session",session);
                AuntDalaActivity.this.startActivity(it);
        ...
        search.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if(search.getText()!=null){
                    ...
                    WorksAdapter  newadapter=new WorksAdapter(AuntDalaActivity.this,R.layout.listitem,searchresult);
