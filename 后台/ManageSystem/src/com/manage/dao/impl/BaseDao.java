...
public class BaseDao implements IBaseDao {
	...
	public <T> PagerModel findPageByCreateAlias(Class<T> clazz,int pageno,int pagesize,List<Order> orderlist,List<Criterion> cronlist, List<String> alias)
	{
		Criteria criteria = getSession().createCriteria(clazz);
		if(alias != null){
			for(String str : alias){
				criteria.createAlias(str+'s', str, CriteriaSpecification.LEFT_JOIN);
			}
		}
		if (cronlist!=null) {
			for (Criterion c : cronlist) {
