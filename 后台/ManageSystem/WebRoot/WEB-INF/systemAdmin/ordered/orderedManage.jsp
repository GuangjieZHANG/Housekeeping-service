...
<form id="pagerForm" method="post" action="orderedmanage">
	<input type="hidden" name="pageNum" value="1" />
	<input type="hidden" name="numPerPage" value="<s:property value="pm.numPerPage"/>" />
</form>

<form onsubmit="return navTabSearch(this);" action="SearchOrdered_List" method="post">
<div class="pageHeader">
	<div class="searchBar">
		<table class="searchContent">
			<tr>
				<td align="left">
					订单编号:<s:textfield theme="simple" name="searchOrderedId" ></s:textfield>
				</td>
				<td align="left">
					服务类型:
...
<div class="pageContent">
	<div class="panelBar">         
		<ul class="toolBar">
			<li><a class="add" href="Ordered_Add?projectid=${projectid}" target="navTab" rel="Ordered_Add"><span>新增</span></a></li>
			<li><a class="edit" id="Ordered_Modify" href="Ordered_Modify?ordered_id={ordered_id}" target="navTab" rel="Ordered_Modify"><span>修改</span></a></li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids" href="Ordered_BatchDelete" class="delete"><span>删除</span></a></li>
		</ul>
	</div>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			<s:iterator value="pm.list" status="index"  var="cp">
				<tr target="ordered_id" rel="<s:property value="orderId"/>" modifyTagId="Ordered_Modify"> 
					...
					<td align="center"><s:date name="finishTime" format="yyyy-MM-dd HH:mm:ss"/></td>
