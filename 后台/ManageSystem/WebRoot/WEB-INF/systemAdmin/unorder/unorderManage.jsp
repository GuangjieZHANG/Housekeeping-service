<%@page import="com.manage.util.PagerModel"%>
<%@ page language="java" import="java.lang.reflect.Type, java.util.*, java.util.Map.*, com.google.gson.*, com.google.gson.reflect.TypeToken" pageEncoding="UTF-8" contentType="text/html; charset=UTF-8"%>
...
<%!
	public String jsonToString(String json){
		...
		Map<String, String> sList = gson.fromJson(json, type);
		Entry<String, String> entry;  
		for(Iterator<Entry<String, String>> iterator = sList.entrySet().iterator(); iterator.hasNext();)  
		{
			entry = (Entry<String, String>)iterator.next();
			result.append(null==entry.getValue() ? "" : entry.getValue());
		}  
...
<form id="pagerForm" method="post" action="unordermanage">
...
<form onsubmit="return navTabSearch(this);" action="SearchUnorder_List" method="post">
	<div class="pageHeader">
		<div class="searchBar">
			<table class="searchContent">
			<tr>
				<td align="left">
					订单编号:<s:textfield theme="simple" name="searchUnorderId" ></s:textfield>
				</td>
				<td align="left">
					服务类型:
				...
				<td align="left">
					顾客姓名:<s:textfield theme="simple" name="searchUserName" ></s:textfield>
				</td>
				<td align="left">
					顾客电话:<s:textfield theme="simple" name="searchUserPhoneNumber" ></s:textfield>
				</td>
			</tr>
			<tr>
				<td align="left">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="Unorder_Add" target="navTab" rel="Unorder_Add"><span>新增</span></a></li>
			<li><a class="edit" id="Unorder_Modify" href="Unorder_Modify?unorder_id={unorder_id}" target="navTab" rel="Unorder_Modify"><span>修改</span></a></li>
			<li><a title="确实要删除这些记录吗?" target="selectedTodo" rel="ids" href="Unorder_BatchDelete" class="delete"><span>删除</span></a></li>
		</ul>
	</div>
	...
	<table class="table" width="100%" layoutH="138">
		...
		<tbody>
			<s:iterator value="pm.list" status="index"  var="cp">
				<tr target="unorder_id" rel="<s:property value="orderId"/>" modifyTagId="Unorder_Modify"> 
