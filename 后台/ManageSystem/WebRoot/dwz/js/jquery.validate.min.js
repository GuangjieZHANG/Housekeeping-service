    ...
    a.extend(a.validator, {
        ...
        prototype: {
            init: function() {
                ...
                a(this.currentForm).validateDelegate(":text, [type='password'], [type='file'], " +
                		"select, textarea, [type='number'], [type='search'] ,[type='tel'], " +
                		"[type='url'], [type='idcard'],[type='email'], [type='datetime'], " +
                		"[type='date'], [type='month'], [type='week'], [type='time'], " +
                		"[type='datetime-local'], [type='range'], [type='color'] ", "focusin focusout keyup", d).validateDelegate("[type='radio'], [type='checkbox'], select, option", "click", d),
        ...
        methods: {
            ...
            idcard: function(a, b) {
                return this.optional(b) || /^[1-9]\d{16}(\d|x|X)$/.test(a)
              },
