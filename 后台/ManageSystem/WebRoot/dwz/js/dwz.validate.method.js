...
(function($){
	if ($.validator) {
		...
		$.validator.addMethod("ID_card", function(value, element) {
			return this.optional(element) || /^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])((\d{4})|\d{3}[A-Z]|\d{3}[a-z])$/.test(value);
		}, "Please specify a valid cardId");
		
		$.validator.addMethod("tel", function(value, element) {
			return this.optional(element) || /^(?:(?:1[3-9]\d{9})|(?:0\d{2,3}[- ]?[1-9]\d{6,7})|(?:[48]00[- ]?[1-9]\d{6}))$/.test(value);
